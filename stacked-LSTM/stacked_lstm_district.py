...
def parse_args() -> Config:
    p = argparse.ArgumentParser(description="Direct multi-horizon stacked LSTM for the dengue district-panel pipeline.")
    p.add_argument("--input", type=str, default="./data/raw/prime_dataset_model_input_with_purge.csv")
    p.add_argument("--output_dir", type=str, default="stacked-LSTM/outputs")
...
def main():
    ...
    save_json(best_configs, out_dir / "stacked_lstm_best_configs.json")
